...
// Confetti
(function() {
  var COLORS, Confetti, numConfetti, PI_2, canvas, confetti, context, drawCircle, i, range, resizeWindow, xpos;
  ...
  confetti = (function() {
    var j, ref, results;
    results = [];
    for (i = j = 1, ref = numConfetti; (1 <= ref ? j <= ref : j >= ref); i = 1 <= ref ? ++j : --j) {
